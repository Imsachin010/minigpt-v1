...
# dataset
''' A small corpus of sentences for training, We perform preprocessing to create a vocabulary and map words to indices. This steo is rrequired for training the TinyGPT model.'''
